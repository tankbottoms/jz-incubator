...
const project_name = `Movement DAO's Ascended Ape Collection`;
const project_symbol = `MAPE-1420`;
...
const project_base_uri = `ipfs://QmZT9h4Q6x5RKwLU6PD9s47j823WLH4KhuTb1BJtf19PEx/`;
